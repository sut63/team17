...
export function EntProfessorEdgesFromJSONTyped(
  json: any,
  ...
  return {
    profFacu: !exists(json, 'ProfFacu')
      ? undefined
      : EntFacultyFromJSON(json['ProfFacu']),
    profPre: !exists(json, 'ProfPre')
      ? undefined
      : EntPrefixFromJSON(json['ProfPre']),
    profPros: !exists(json, 'ProfPros')
      ? undefined
      : EntProfessorshipFromJSON(json['ProfPros']),
  };
}

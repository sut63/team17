...
export interface GetPostalRequest {
    id: number;
}
...
export interface ListPostalRequest {
    limit?: number;
    offset?: number;
}
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     * get postal by ID
     * Get a postal entity by ID
     */
    async getPostalRaw(requestParameters: GetPostalRequest): Promise<runtime.ApiResponse<EntPostal>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getPostal.');
        }
        ...
        const response = await this.request({
            path: `/postals/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });

        return new runtime.JSONApiResponse(response, (jsonValue) => EntPostalFromJSON(jsonValue));
    }
     ...
     * Get a postal entity by ID
     */
    async getPostal(requestParameters: GetPostalRequest): Promise<EntPostal> {
        const response = await this.getPostalRaw(requestParameters);
        return await response.value();
    }
    ...
    /**
     * list postal entities
     * List postal entities
     */
    async listPostalRaw(requestParameters: ListPostalRequest): Promise<runtime.ApiResponse<Array<EntPostal>>> {
        const queryParameters: runtime.HTTPQuery = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(EntPostalFromJSON));
    }
     ...
     * List postal entities
     */
    async listPostal(requestParameters: ListPostalRequest): Promise<Array<EntPostal>> {
        const response = await this.listPostalRaw(requestParameters);
        return await response.value();
    }

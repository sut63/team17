...
import { isEmptyStatement, isImportDeclaration, isExportDeclaration, isStringLiteral, isClassDeclaration, isFunctionDeclaration, isInterfaceDeclaration, isTypeAliasDeclaration, isModuleDeclaration, isIdentifier, isEnumDeclaration, isVariableStatement, isCallExpression, isObjectLiteralExpression, isPropertyAssignment, sys, ScriptTarget, createCompilerHost, createProgram as createProgram$1, findConfigFile, readConfigFile, formatDiagnostic, parseJsonConfigFileContent, formatDiagnostics, createSourceFile, isLiteralExpression, isPropertyAccessExpression, isPrivateIdentifier, getCombinedModifierFlags, idText, SyntaxKind, isComputedPropertyName, isPropertyDeclaration, isPropertySignature, isIndexSignatureDeclaration, isMethodDeclaration, isMethodSignature, isConstructorDeclaration, isConstructSignatureDeclaration, isCallSignatureDeclaration, isGetAccessorDeclaration, isSetAccessorDeclaration, isTypeReferenceNode, isTypeLiteralNode, isArrayTypeNode, isTupleTypeNode, isNamedTupleMember, isParenthesizedTypeNode, isTypeOperatorNode, isTypePredicateNode, isUnionTypeNode, isIntersectionTypeNode, isMappedTypeNode, isConditionalTypeNode, isIndexedAccessTypeNode, isFunctionOrConstructorTypeNode, isImportTypeNode, isTypeQueryNode, isTypeNode, isInferTypeNode, isLiteralTypeNode, isModuleBlock, isNamespaceExport, ModifierFlags, isExportAssignment, isImportEqualsDeclaration, NodeFlags, isExternalModuleReference, isNamedImports, DiagnosticCategory, nodeModuleNameResolver } from 'typescript';
...
class DeclarationScope {
    ...
    fixModifiers(node) {
        ...
        if (!hasDeclare &&
            (isClassDeclaration(node) || isFunctionDeclaration(node) || isVariableStatement(node))) {
    ...
    convertTypeNode(node) {
        ...
        if (isNamedTupleMember(node) || isParenthesizedTypeNode(node) || isTypeOperatorNode(node) || isTypePredicateNode(node)) {

 ...
 * for a full list of supported scopes.
 */
declare const auth0AuthApiRef: ApiRef<OpenIdConnectApi & ProfileInfoApi & BackstageIdentityApi & SessionStateApi>;
/**
...
declare const configApiRef: ApiRef<Config>;
...
declare const UserIcon: React.ComponentType<OverrideProps<SvgIconTypeMap<{}, "svg">, "svg">>;
declare const GroupIcon: React.ComponentType<OverrideProps<SvgIconTypeMap<{}, "svg">, "svg">>;
...
declare class MutableRouteRef {
    ...
    get icon(): ComponentClass<OverrideProps<SvgIconTypeMap<{}, "svg">, "svg">, any> | FunctionComponent<OverrideProps<SvgIconTypeMap<{}, "svg">, "svg">> | undefined;
    get path(): string;
    get title(): string;
}
...
declare class GithubAuth implements OAuthApi, SessionStateApi {
    ...
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions): GithubAuth;
    sessionState$(): Observable<SessionState>;
...
declare class GitlabAuth implements OAuthApi, SessionStateApi {
    private readonly sessionManager;
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions$1): GitlabAuth;
    sessionState$(): Observable<SessionState>;
...
declare class GoogleAuth implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions$2): GoogleAuth;
    sessionState$(): Observable<SessionState>;
...
declare class OAuth2 implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, SessionStateApi {
    private readonly sessionManager;
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions$3): OAuth2;
    sessionState$(): Observable<SessionState>;
...
declare class OktaAuth implements OAuthApi, OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions$4): OktaAuth;
    sessionState$(): Observable<SessionState>;
...
declare class Auth0Auth implements OpenIdConnectApi, ProfileInfoApi, BackstageIdentityApi, SessionStateApi {
    private readonly sessionManager;
    static create({ backendUrl, basePath, environment, provider, oauthRequestApi, }: CreateOptions$5): Auth0Auth;
    sessionState$(): Observable<SessionState>;
    constructor(sessionManager: SessionManager<Auth0Session>);
    getIdToken(options?: AuthRequestOptions): Promise<string>;
    logout(): Promise<void>;
    getBackstageIdentity(options?: AuthRequestOptions): Promise<BackstageIdentity | undefined>;
    getProfile(options?: AuthRequestOptions): Promise<ProfileInfo | undefined>;

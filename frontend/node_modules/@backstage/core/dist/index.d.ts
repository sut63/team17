...
import privateExports, { AppOptions, IconComponent, OAuthApi, OpenIdConnectApi, ApiRef, SessionStateApi, ProfileInfoApi, BackstageIdentityApi, SignInPageProps } from '@backstage/core-api';
...
declare type SignInConfig = {
    id: string;
    title: string;
    message: string;
    apiRef: ApiRef<OAuthApi & ProfileInfoApi & BackstageIdentityApi & SessionStateApi>;
};
declare type IdentityProviders = ('guest' | 'custom' | SignInConfig)[];

...
// GendStudOrErr returns the GendStud value or an error if the edge
// was not loaded in eager-loading.
func (e GenderEdges) GendStudOrErr() ([]*Student, error) {
	if e.loadedTypes[0] {
		return e.GendStud, nil
	}
	return nil, &NotLoadedError{edge: "gend_stud"}
}
...
// QueryGendStud queries the gend_stud edge of the Gender.
func (ge *Gender) QueryGendStud() *StudentQuery {
	return (&GenderClient{config: ge.config}).QueryGendStud(ge)
}
